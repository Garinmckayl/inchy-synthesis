...
export function InteractiveCryptoChart({ title, data, chart }: CryptoChartProps) {
  ...
  const options: EChartsOption = {
    ...
    tooltip: {
      ...
      formatter: (params: any) => {
        ...
        const prevPrice =
          chartData[params[0].dataIndex - 1]?.value || currentPrice;
...
export default InteractiveCryptoChart;
