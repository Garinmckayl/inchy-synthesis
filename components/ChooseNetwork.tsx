...
import {
  ...
  import ethIcon from '../public/icon/eth.png';
import bnbIcon from '../public/icon/bnb.png';
/**
...
function ChooseNetwork({ handleChangeNetwork }) {
    ...
    return (
                ...
                <Menu.Button className={ChooseNetworkStyle.button}>
                    <div className={ChooseNetworkStyle.buttonContent}>
                        <img
                            ...
                            src={selectedNetwork === 'Ethereum' ? 'icon/eth.png' : 'icon/bnb.png'}
        ...
        <SelectGroup>
          ...
          {options.map((network) => (
            <SelectItem key={network.value} value={network.value} onClick={() => handleSelect(network)}>
              {network.label}
            </SelectItem>
          ))}
          </SelectGroup>
